  ...
  return (
    <>
      ...
      <div className="px-5 py-4 rounded-lg w-full h-auto  shadow-md my-3 mx-auto border border-gray-300 ">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-[19px]">

          <div className="flex flex-col w-full gap-5 mt-[10px] ">
            <label className="text-sm font-semibold text-[#051B44]  w-full ">Skills</label>
            <div className="flex flex-col w-full  border border-gray-300 rounded-md p-3 ">
              <div className="relative w-full px-[14px] py-[13px] h-[50px] rounded-[4px] border">
                ...
                <input
                  ...
                  className="w-full h-[24px] pl-10 pr-3   text-black font-normal py-2 focus:outline-none focus:border-gray-400 focus:ring-0"
                />
              </div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="flex flex-wrap gap-x-6 gap-y-5 p-4 max-h-60 overflow-y-auto ">

                    {filteredSkills.map((skill, index) => (
                      <label
                        key={index}

                        className="flex items-center gap-[10px] font-normal text-base h-6 p-[10px]" >
                        <input
                          type="checkbox"
                          className="w-4 h-4 border border-gray-300 rounded-md accent-[#008080] "
            ...
            <div className="flex flex-col w-full">
              <label className="text-sm font-semibold text-[#051B44] mb-[10px] ">GPA</label>
              <Controller
                name="gpa"
                control={control}
            ...
            <div className="flex flex-col w-full ">
              <label className="text-sm font-semibold text-[#051B44] mb-[10px] ">Qualification</label>
              <Controller
                name="qualification"
                control={control}
            ...
            <div className="flex flex-col w-full mb-6">
              <label className="text-sm font-semibold text-[#051B44] mb-[10px] ">Description</label>
              <Controller
                name="description"
                control={control}
