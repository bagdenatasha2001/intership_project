...
//   return (
//     <>
//       <div className="h-auto mb-4 w-full shadow rounded-xl mt-4 border border-gray-33">
...
//                               <img
//                                 src={Danger}
//                                 className="ml-1 cursor-pointer text-red-500 hover: "
...
//                           {alertIndex === index && (
//                             <div className=" bg-red-100 text-red-600 w-32">
//                              <p className=" flex justify-center items-center text-[8px] "> This vacancy has been closed by the admin.</p>
//                             </div>
//                           )}
//                         </div>
//                       </td>
                ...
                <tbody>
                  {internships.map((item, index) => (
                    <tr key={index} className="border-b border-gray-200 gap-3">
                      ...
                      <td className="flex items-center justify-center py-5 gap-3">
                        <button className="text-blue-500">
                          <img src={eye} alt="view" />
                        </button>
                        <button className="text-green-500">
